  ...
  return (
    <div className="relative w-full max-w-full md:max-w-5xl mx-auto my-6 md:my-12 overflow-hidden">
      ...
      <div className="flex sm:gap-10 h-64 sm:h-80 md:h-96 relative pl-0">
        ...
        <div className="flex-shrink-0 w-1/3 md:w-1/4 pl-0">
        ...
        {/* Middle Image (Large) */}
        <div className="flex-shrink-0 w-1/2 z-10 scale-105 md:scale-110">
        ...
        <div className="flex-shrink-0 w-1/3 md:w-1/4 -mr-8 sm:-mr-10 md:-mr-12 relative overflow-hidden">
